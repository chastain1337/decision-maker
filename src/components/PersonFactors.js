...
class personFactors extends React.Component {
  ...
  handleChangeI = event => {
    ...
    this.props.updateFactor("ind", this.props.index, event.target);
  };
  ...
  handleChangeD = event => {
    ...
    this.props.updateFactor("dep", this.props.index, event.target);
  };
